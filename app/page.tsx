      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/businesses" className="inline-flex items-center bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-medium rounded-full px-3 py-2 transition-colors">
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/marketplace" className="inline-flex items-center bg-purple-500 hover:bg-purple-600 text-white text-sm font-medium rounded-full px-3 py-2 transition-colors">
