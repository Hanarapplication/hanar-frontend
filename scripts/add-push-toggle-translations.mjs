...
const byLang = {
  ...
  kk: {
    [ON_KEY]: 'Құрылғыда push хабарландыруларын алуды тоқтату үшін оны өшіріңіз.',
    [OFF_KEY]: 'Енді құрылғыда push хабарландыруларын алмайсыз.',
  },
  ko: {
  ...
  my: {
    [ON_KEY]: 'သင့်စက်ပစ္စည်းတွင် push အကြောင်းကြားချက်များ မရရှိတော့ရန် ၎င်းကို ပိတ်ပါ။',
    [OFF_KEY]: 'သင့်စက်ပစ္စည်းတွင် push အကြောင်းကြားချက်များ မရရှိတော့ပါ။',
  },
  ne: {
...
for (const file of fs.readdirSync(localesDir)) {
  ...
  const tr = byLang[lang] || byLang.en;
  data[ON_KEY] = tr[ON_KEY];
  data[OFF_KEY] = tr[OFF_KEY];
