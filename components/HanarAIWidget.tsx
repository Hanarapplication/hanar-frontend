...
"I'm here to help with immigrant life and local services. Try asking me about that!"
  ...
  return (
    <>
      <div
        className="fixed right-6 z-50 bg-transparent cursor-pointer transition transform hover:scale-105 bottom-[calc(5rem+env(safe-area-inset-bottom,0px))]"
      ...
      {open && (
        <div className="fixed right-6 z-50 flex h-96 w-80 flex-col rounded-2xl border border-gray-200 bg-white shadow-2xl bottom-[calc(9rem+env(safe-area-inset-bottom,0px))]">
